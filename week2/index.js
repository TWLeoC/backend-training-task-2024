...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21); // true, JS在遇到字串型別的乘法時，會很貼心的轉換成數字型別
...
console.log(`贈品還剩下${giftNum}個`); // Bob有達成消費門檻，因此有獲得贈品，贈品數量剩279
...
// 練習：計算小明今日消耗的卡路里
calorieBurn = activities.bike.caloriesPerMinute * 10 + activities.running.caloriesPerMinute * 30 + activities.yoga.caloriesPerMinute * 40 + activities.bike.caloriesPerMinute * 10;
